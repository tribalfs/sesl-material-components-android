...
class StackViewGroup(val rootView: FrameLayout) {
    ...
    class SceneStack<T : View> : Stack<T>() {
        ...
        override fun push(item: T): T {
            if (isNotEmpty()) peek().visibility = View.INVISIBLE/*sesl9*/
    ...
    private val showHideInterpolator: Interpolator =
			AnimationUtils.loadInterpolator(rootView.context, androidx.appcompat.R.interpolator.sesl_interpolator_0_0_1_1)
