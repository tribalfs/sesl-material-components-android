 ...
 */
/**
 * A model class extending [SuggestAppBarItemModel] specifically designed for [SuggestAppBarItemWhiteCaseView],
 * providing tailored styling and behavior for views displayed on a white background ("white case").
 *
 * Use the [Builder] class to construct instances of [SuggestAppBarItemWhiteCaseModel].
 *
 * @param T The type of [SuggestAppBarItemWhiteCaseView] associated with this model.
 ...
 */
open class SuggestAppBarItemWhiteCaseModel<T : SuggestAppBarItemWhiteCaseView> @JvmOverloads constructor(
    kclazz: KClass<T>,
    context: Context,
    title: String? = null,
    titleMaxLine: Int = 0,
    ...
    /**
     * Builder class for constructing instances of [SuggestAppBarItemWhiteCaseModel].
     *
