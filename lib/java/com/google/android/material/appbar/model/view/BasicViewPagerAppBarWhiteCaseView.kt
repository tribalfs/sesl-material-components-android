...
abstract class BasicViewPagerAppBarWhiteCaseView @JvmOverloads constructor(
    ...
    override fun updateResource(context: Context) {
        ...
        val offStateDrawable =
            context.getDrawable(androidx.appcompat.R.drawable.sesl_viewpager_indicator_on_off)?.mutate()?.apply {
                if (this is GradientDrawable) {
                    setColor(ColorStateList.valueOf(getViewPagerIndicatorOffWithWhiteCaseColor(context)))
                } else {
        ...
        val onStateDrawable =
            context.getDrawable(androidx.appcompat.R.drawable.sesl_viewpager_indicator_on_off)?.mutate()?.apply {
                if (this is GradientDrawable) {
                    setColor(ColorStateList.valueOf(getViewPagerIndicatorOnWithWhiteCaseColor(context)))
                } else {
