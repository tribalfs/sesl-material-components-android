...
public final class MaterialContainerTransform extends Transition {
  ...
  private static void captureValues(
    ...
    if (ViewCompat.isLaidOut(view) || view.getWidth() != 0 || view.getHeight() != 0) {
      ...
      RectF bounds = view.getParent() == null ? getRelativeBounds(view) : getLocationInWindow(view);//custom
  ...
  public Animator createAnimator(
    ...
    RectF drawingViewBounds = getLocationInWindow(drawingView);//custom
  ...
  private static RectF calculateDrawableBounds(
    ...
    if (boundingView != null) {
      RectF drawableBounds = getLocationInWindow(boundingView);//custom
